...
class deprecatedWriter extends HTMLWriter
{
    ...
    public function deprecatedWriter(&$doclet)
    {
        ...
        if ($deprecatedClasses) {
            echo '<table id="deprecated_class" class="detail table table-striped table-hover">', "\n";
            echo '<thead><tr><th colspan="2" class="title">Deprecated Classes</th></tr></thead>', "\n";
        ...
        if ($deprecatedFields) {
            echo '<table id="deprecated_field table table-striped table-hover" class="detail">', "\n";
            echo '<thead><tr><th colspan="2" class="title">Deprecated Fields</th></tr><thead>', "\n";
        ...
        if ($deprecatedMethods) {
            echo '<table id="deprecated_method" class="detail table table-striped table-hover">', "\n";
            echo '<thead><tr><th colspan="2" class="title">Deprecated Methods</th></tr></thead>', "\n";
        ...
        if ($deprecatedGlobals) {
            echo '<table id="deprecated_global" class="detail table table-striped table-hover">', "\n";
            echo '<thead><tr><th colspan="2" class="title">Deprecated Globals</th></tr></thead>', "\n";
        ...
        if ($deprecatedFunctions) {
            echo '<table id="deprecated_function" class="detail table table-striped table-hover">', "\n";
            echo '<thead><tr><th colspan="2" class="title">Deprecated Functions</th></tr></thead>', "\n";
