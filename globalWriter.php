...
class globalWriter extends HTMLWriter
{
    ...
    public function globalWriter(&$doclet)
    {
        ...
        foreach ($packages as $packageName => $package) {
            ...
            if ($globals) {
                ksort($globals);
                echo '<table id="summary_global" class="title table table-striped table-hover">', "\n";
                ...
                foreach ($globals as $global) {
                    ...
                    echo '<h3 class="panel-title pull-left" id="', $global->name(),'">', $global->name(), "</h3>\n";
                    $this->_sourceLocation($global);
                    echo '<span class="clearfix"></span> </div><div class="panel-body">';
