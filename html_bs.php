...
/** The «HTML_BS» doclet. This doclet generates HTML output
 * uses Twitter Bootstrap CSS framework. Based on PHPDoctor «standard» doclet.
 *
 * Recommended to use Text formatter in INI file:
 * formatter = textFormatter
 *
 * @author Andrew Matsovkin aka Macik
 * @version 0.1.0
 * @package PHPDoctor\Doclets\HtmlBs
 */
class Html_bs extends Doclet
{
     ...
     * @var str
     */
    public $_bottom = '<small>This documentation pages was generated by <a href="http://peej.github.com/phpdoctor/" target="_blank">PHPDoctor</a> with <a href="https://github.com/macik/phpdoctor-html_bs" target="_blank">«HTML_BS» doclet</a> styles.</small>';
     ...
     */
    public function Html_bs(&$rootDoc, $formatter)
    {
