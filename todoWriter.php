...
class todoWriter extends HTMLWriter
{
    ...
    public function todoWriter(&$doclet)
    {
        ...
        if ($todoClasses) {
            echo '<table id="todo_class" class="detail table table-striped table-hover">', "\n";
        ...
        if ($todoFields) {
            echo '<table id="todo_field" class="detail table table-striped table-hover">', "\n";
        ...
        if ($todoMethods) {
            echo '<table id="todo_method" class="detail table table-striped table-hover">', "\n";
        ...
        if ($todoGlobals) {
            echo '<table id="todo_global" class="detail table table-striped table-hover">', "\n";
        ...
        if ($todoFunctions) {
            echo '<table id="todo_function" class="detail table table-striped table-hover">', "\n";
